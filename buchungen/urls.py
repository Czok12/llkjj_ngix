...
urlpatterns = [
    ...
    path("<uuid:pk>/bearbeiten/", views.BuchungssatzUpdateView.as_view(), name="bearbeiten"),
    ...
    # AJAX-Endpoints
    path("ajax/<uuid:pk>/validieren/", views.buchung_validieren_ajax, name="ajax_validieren"),
    path("ajax/konten/autocomplete/", views.konten_autocomplete, name="konten_autocomplete"),
