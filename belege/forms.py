...
class BelegUploadForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'datei': forms.FileInput(attrs={
                'class': 'form-control',
                'accept': '.pdf',
                'id': 'datei-upload'
            }),
            'beleg_typ': forms.Select(attrs={
                'class': 'form-select'
            }),
...
class BelegBearbeitungForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'rechnungsdatum': forms.DateInput(attrs={
                'class': 'form-control',
                'type': 'date'
            }),
            ...
            'geschaeftspartner': forms.Select(attrs={
                'class': 'form-select'
            }),
            'beschreibung': forms.TextInput(attrs={
                'class': 'form-control'
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['geschaeftspartner'].empty_label = "-- Geschäftspartner auswählen --"
...
class NeuerGeschaeftspartnerForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'partner_typ': forms.Select(attrs={
                'class': 'form-select'
            }),
