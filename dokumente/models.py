...
class DokumentKategorie(models.Model):
    ...
    geändert_am = models.DateTimeField(auto_now=True, verbose_name="Geändert am")
...
class Dokument(models.Model):
    ...
    def ist_fällig_bald(self):
        ...
        heute = date.today()
        erinnerungsdatum = self.fälligkeitsdatum - timedelta(
...
class DokumentAktion(models.Model):
    ...
    beschreibung = models.TextField(
        help_text="Beschreibung der durchgeführten Aktion", verbose_name="Beschreibung"
    )

    notizen = models.TextField(
        blank=True, help_text="Zusätzliche Notizen", verbose_name="Notizen"
    )
